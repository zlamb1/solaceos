...
KRNSRCS := $(ARCHDIR)/io.c $(ARCHDIR)/console.c $(SRCDIR)/kmain.c $(SRCDIR)/string.c $(SRCDIR)/panic.c \
           $(SRCDIR)/console.c $(SRCDIR)/vga.c $(SRCDIR)/print.c $(SRCDIR)/kprint.c $(SRCDIR)/palloc.c
